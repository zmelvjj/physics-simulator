    ...
    <div>
      ...
      >
        <div style={{position: 'absolute',borderRadius: "1vh"}}>
          <div>
            <label style={{position:'absolute',top:'1vh',left:'4vh',color:'white'}}>
              마찰력:
              <input
                type="number"
                value={friction}
            ...
            <label style={{position:'absolute',top:'6vh',left:'4vh',color:'white'}}>
              공기저항:
              <input
                type="number"
                value={frictionAir}
            ...
            <label style={{position:'absolute',top:'11vh',left:'4vh',color:'white'}}>
              정지마찰:
              <input
                type="number"
            ...
            <div onMouseDown={applySettings} style={{
              borderRadius:'2vh', position:'absolute', left:'3vh', top:'17vh', width:'20vh',height:'2vh',
              backgroundColor:'black', color:'white',justifyContent: 'center',alignItems: 'center',display: 'flex'
              }}>저장</div>
          </div>
        </div>
      </div>
